...
export default function InputBox({ prompt, setPrompt, onSubmit }: InputProps) {
  return (
    <div className="bg-[#171717] flex w-full h-28 border border-white/20 rounded-xl gap-2 p-4">
      <textarea
